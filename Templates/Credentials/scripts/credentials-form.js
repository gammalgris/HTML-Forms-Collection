...
var TABLE_NAME = "credentialsTable"
...
function addRow() {
	...
	var tbody = getTBodyChild(table);
	checkObject("tbody", tbody);
...
/**
 * Returns the first child element which is a tbody element.
 * 
 * @param aNode
 *
 * @return a child element which is a tbody element or <code>null</code>
 */
function getTBodyChild(aNode) {
...
/**
 * Checks if the specified node is an element of type tbody.
 * 
 * @param aNode
 * 
 * @return <code>true</code> if the specified node is a tbody element, else
 *         <code>false</code>
 */
function isTBodyElement(aNode) {

	if ((aNode.nodeType == ELEMENT_NODE_TYPE) && (aNode.nodeName == 'TBODY')) {
